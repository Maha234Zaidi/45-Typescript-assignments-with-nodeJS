...
let transportsModes :string[] =["City","Honda Motorcycle","Lamborghini car","Corola","Sports bike"];

transportsModes.forEach(mode => console.log(`I would like to own a ${mode}.`))
