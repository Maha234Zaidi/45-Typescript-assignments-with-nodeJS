...
let current_users:string[] = ["ali","zain","alisha","hina","maha","eman"];

let new_users:string[] = ["sana","asma","Hina","saba","Maha"];

for(let user of new_users){
    let condition = current_users.some(current_one_user => current_one_user.toLowerCase() === user.toLowerCase())
    if(condition){
